...
const commonAnimation = {
  init() {
    ...
    // Hero floating cards scroll parallax
    const heroSection = document.querySelector('.hero-section');
    const heroScrollCard1 = document.querySelector('.hero-scroll-card-1');
    const heroScrollCard2 = document.querySelector('.hero-scroll-card-2');
    const heroScrollCard3 = document.querySelector('.hero-scroll-card-3');

    if (heroSection && heroScrollCard1) {
      gsap.to(heroScrollCard1, {
        y: -45,
        scrollTrigger: { trigger: heroSection, start: 'top top', end: 'bottom top', scrub: 1 },
      });
    }
    if (heroSection && heroScrollCard2) {
      gsap.to(heroScrollCard2, {
        y: -28,
        scrollTrigger: { trigger: heroSection, start: 'top top', end: 'bottom top', scrub: 1.5 },
      });
    }
    if (heroSection && heroScrollCard3) {
      gsap.to(heroScrollCard3, {
        y: -38,
